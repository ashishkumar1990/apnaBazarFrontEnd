...
export class cartComponent implements OnInit {
    ...
    userName:string="";
    constructor(private _categoryService: CategoryService,private toastr: ToastrService,private _router:Router,private _cookie:CookieService,private messageService: MessageService) {
    }
